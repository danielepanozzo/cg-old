...
\begin{enumerate}
\item Clone the repository: \url{https://github.com/NYUCG2016/Assignment2}
\item Modify the code following the assignment instructions
\item Add a readme in pdf format that contains a report of what you did with a screenshot for each task
\item Create a \textbf{private} repository in \url{https://github.com/NYUCG2016/} called \textbf{Assignment2\_USER}, where USER is the github username that you used when you filled the registration form
\item Push the code into the newly created repository
\end{enumerate}
